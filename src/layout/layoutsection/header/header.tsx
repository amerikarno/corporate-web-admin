                    ...
                    <div className="header-content">
                        ...
                        <div className="responsive-logo">
                            ...
                            <Link className="responsive-logo-light" to={`${import.meta.env.BASE_URL}dashboards/sales`} aria-label="Brand">
                                <img src={ALLImages('desktoplight')} alt="logo1" className="mx-auto" /></Link>
                        </div>
                            ...
                            <div className="responsive-headernav">
                                <div className="header-nav-right">
                                    ...
                                    <div className="header-profile hs-dropdown ti-dropdown" data-hs-dropdown-placement="bottom-right">
                                        <button id="dropdown-profile" type="button" className="hs-dropdown-toggle ti-dropdown-toggle gap-2 p-0 flex-shrink-0 h-8 w-8 rounded-full border-0 shadow-none focus:ring-gray-400 text-xs dark:focus:ring-white/10">
