import { TAssetData, TMember } from "@/pages/createJob/changeIcoAccount/types";
...
export const columnsMember: TableColumn<TMember>[] = [
    {
      name: "Firstname",
...
export const mockedAssetData : TAssetData ={
    "registerId": "1",
    "asset": {
