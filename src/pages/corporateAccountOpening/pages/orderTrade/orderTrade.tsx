...
export default function OrderTrade(){
    ...
    const [selectedCorporateCode, setSelectedCorporateCode] = useState<string>("");
    ...
    const {
      ...
      const handleCorporateCodeChange = (event: React.ChangeEvent<HTMLInputElement>) => {
