...
import { removeJuristicShareholder, setJuristicShareholder } from "@/features/juristicShareholderSlice/juristicShareholderSlice";
import { useDispatch, useSelector } from "react-redux";
import { RootState } from "@/app/store";
import { getCookies } from "@/lib/Cookies";
import axios from "@/api/axios";
import { TJuristic as TJuristicEdit } from "../../constant/type";
import { useEffect, useState } from "react";
...
export function PageJuristicShareholder({
  ...
  const [choosedEditData,setChoosedEditData] = useState<TJuristicsShareholders>();
