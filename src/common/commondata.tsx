...
export const TeammemberData: TeammemberDataType[] = [
    {
        id: 1,
...
export const TeammemberData1: TeammemberDataType[] = [
...
export interface todolistType {
    ...
    status: string
    priority: string
    assigners: JSX.Element
    badgeclass: string
    statusclass: string
}

export const To_do_List_Data: todolistType[] = [
    {
        id: 1,
